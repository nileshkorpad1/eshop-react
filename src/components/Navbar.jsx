            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav className="me-auto">
                    ...
                    <Link onClick={() => setExpanded(false)} className='NavLinks non-product'
                        to="/collections/mice">Mice</Link>
                    <Link onClick={() => setExpanded(false)} className='NavLinks non-product'
                        to="/collections/headphones">Headphones</Link>

                    <Link onClick={() => setExpanded(false)} className='NavLinks non-product'
                        to="/collections/keyboards">Keyboards</Link>

                    <Link onClick={() => setExpanded(false)} className='NavLinks non-product'
                        to="/collections/accessories">Accessories</Link>
                </Nav>
                <Nav>
