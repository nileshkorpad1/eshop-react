...
export default function SearchPage() {
        ...
        const fetchData = async () => {
            try {
                const {data} = await axios.get(
                    `${BASE_URL}/api/products/search?page=${page}&query=${query}&mainCategory=${mainCategory}&price=${price}&rating=${rating}&order=${order}&pageSize=${pageSize}`
                );
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const { data } = await axios.get(`${BASE_URL}/api/products/categoriesList`);
