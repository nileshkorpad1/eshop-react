...
function AdminProducts() {
    ...
    const handleSubmit = () => {
        if (currentOperation === 'ADD') {
            //add product
            axios.post(`${BASE_URL}/api/products`, formModel, {"headers": {"Authorization": "Bearer " + userInfo.token}}).then((res) => {
            ...
            //edit product
            axios.put(`${BASE_URL}/api/products/${currentItem._id}`, formModel, {"headers": {"Authorization": "Bearer " + userInfo.token}}).then((res) => {
    ...
    const handelDelete = (item) => {
        axios.delete(`${BASE_URL}/api/products/${item._id}`, {"headers": {"Authorization": "Bearer " + userInfo.token}}).then((res) => {
