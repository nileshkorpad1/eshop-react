...
export default function AccountManagement() {
    ...
    useEffect(() => {
        if (userInfo) {
            axios.get(`${BASE_URL}/api/orders/user`, {"headers": {"Authorization": "Bearer " + userInfo.token}})
                .then((response) => {
    ...
    function updateUser(event) {
        ...
        axios.put(`${BASE_URL}/api/users/account`, u, {"headers": {"Authorization": "Bearer " + userInfo.token}})
            .then((response) => {
